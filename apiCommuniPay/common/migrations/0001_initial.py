    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_id', models.BigIntegerField(blank=True, db_index=True, null=True, validators=[django.core.validators.MinValueValidator(1)])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('status', 'pending')), fields=('project', 'initiator'), name='one_pending_intent_per_user_and_project'),
        ),
        migrations.AddConstraint(
            model_name='chatlinkintent',
